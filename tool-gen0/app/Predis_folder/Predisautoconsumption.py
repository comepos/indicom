...
indicator.computeNormalizedAutoconsumption('daily', 3600*24)
indicator.computeNormalizedAutoconsumption('weekly', 3600*24*7)
indicator.computeNormalizedAutoconsumption('monthly',3600*24*30)
indicator.computeNormalizedAutoconsumption('yearly', 3600 * 24 * 30 * 12)
